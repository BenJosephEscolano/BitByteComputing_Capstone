...
public class Level implements Serializable {
    ...
    private void loadLevelData(){
        ...
        level.get(level.size()-1).setSpawnPoint1(new Vector(252, 350.0f));
        level.get(level.size()-1).setSpawnPoint2(new Vector(966, 350.0f));
        ...
        level.get(level.size()-1).setSpawnPoint1(new Vector(288, 250.0f));
        ...
        level.get(level.size()-1).setSpawnPoint1(new Vector(336, 150.0f));
        level.get(level.size()-1).setSpawnPoint2(new Vector(882, 150.0f));
